...
const struct mx6_mmdc_calibration b08_mmcd_calib = {
...
/* MT41K256M16 */
static struct mx6_ddr3_cfg b08_mem_ddr = {
	.mem_speed = 1600,
	.density = 4,
	.width = 32,
	.banks = 8,
...
static void spl_dram_init(void)
{
	...
	mx6sx_dram_iocfg(b08_mem_ddr.width, &mx6_ddr_ioregs, &mx6_grp_ioregs);
	mx6_dram_cfg(&sysinfo, &b08_mmcd_calib, &b08_mem_ddr);
